        ...
        <div class="p-5">
            <form id="support-form" onsubmit="submitSupportForm(event)">
                ...
                <div class="mb-3">
                    ...
                    <div class="relative">
                        <select name="type" style="-webkit-appearance: none; -moz-appearance: none; background-image: none !important;" class="w-full py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors appearance-none cursor-pointer {{ App::getLocale() == 'ar' ? 'pl-8 pr-3' : 'pr-8 pl-3' }}">
                        ...
                        <!-- Custom Arrow Icon -->
                        <div class="absolute inset-y-0 flex items-center px-2 pointer-events-none text-gray-500 {{ App::getLocale() == 'ar' ? 'left-0' : 'right-0' }}">
