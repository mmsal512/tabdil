...
@auth
    @if(Auth::user()->user_type === 'admin')
        ...
        <li>
            <a href="{{ route('admin.ai.studio') }}" class="{{ request()->routeIs('admin.ai.studio') ? 'bg-gray-50 text-primary-600' : 'text-gray-700 hover:text-primary-600 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                <svg class="{{ request()->routeIs('admin.ai.studio') ? 'text-primary-600' : 'text-gray-400 group-hover:text-primary-600' }} h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
